...
def coco_classes():
    return [
         'Miridae', 'Flatidae', 'Aphididae', 'Larva_Scarabaeidae', 'Larva_Crambidae',
        'Adult_Sphingidae', 'Adult_Scarabaeidae', 'Adult_Cerambycidae', 'Fulgoridae', 'Acrididae',
        'Gryllotalpidae', 'Larva_Noctuidae', 'Adult_Chrysomelidae', 'Larva_Sphingidae', 'Adult_Crambidae',
        'Adult_Nymphalidae', 'Larva_Limacodidae', 'Adult_Limacodidae', 'Larva_Cerambycidae', 'Cicadellidae',
        'Adult_Noctuidae', 'Adult_Coccinellidae', 'Adult_Elateridae', 'Delphacidae', 'Larva_Coccinellidae',
        'Adult_Papilionidae', 'Larva_Elateridae', 'Larva_Papilionidae', 'Larva_Nymphalidae', 'Larva_Chrysomelidae'
    ]
